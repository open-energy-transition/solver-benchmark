      ...
      <ContentSection>
        <div className="rounded-xl">
          ...
          <p>
            ...
            benchmark run, we measure runtime and memory consumption of the
            solver, along with{" "}
            ...
            solvers with their default options, with some exceptions – see full
            details on our{" "}
            ...
            constraints for each problem instance, along with information about
            the scenario being modelled by each problem, this along with
          ...
          <p>
            ...
            in an introductory and accessible manner. Advanced users, and those
            wishing to dig into more details can visit the
        ...
        <div className="rounded-xl">
          ...
          <p>
            ...
            out or errored is assumed to have a runtime equal to the timeout
            with which it was run. We split our set of problems by
            <Popup
              on={["hover"]}
          ...
          <p>
            ...
            representative for that modelling framework. Solvers that timed out
            or errored on a particular problem are indicated by red text above
            the corresponding bar. 4 out of the 7 problems can be solved by at
            least one open source solver, with different solvers (HiGHS or SCIP)
          ...
          <p>
            ...
            scripts to benchmark solvers on their own problems before picking a
            solver, and also encourage modellers to contribute problems that can
            help us make our benchmark set more representative and diverse.
            Reach out to us if you'd like to contribute!
          </p>
        </div>
        <div className="rounded-xl">
          <h4
          ...
          <p>
            ...
            intention of finding the largest ones solvable by open solvers – so
            there could be larger problems solvable by open solvers than those
            in our set. This section can still be used to get an idea of the
            kinds of spatial and temporal resolutions that are solvable in
            reasonable time periods by open source solvers, and we encourage the
            community to contribute more benchmark problems so we can more
            accurately identify the boundary of feasibility. Clicking on any
            benchmark problem name takes you to the benchmark details page that
            contains more information on the model scenario, various size
          ...
          <p>
            The main takeaway from the above table is that model size, in terms
            of number of variables/constraints, has a strong influence on
            runtime. This is despite the fact that the above problems do not
            ...
            realistic TEMOA-based problem like `temoa-US_9R_TS_NZ 9-12` does not
            have similar runtime to the largest solved TIMES-based model
            (Times-Ireland-noco2-counties 26-1ts): despite both having {">"}1e6
            variables.
          </p>
          <ProblemClassTable problemClass="MILP" />
          <p>
            We note that we do not yet have large problem instances from some
            modelling frameworks in our benchmark set. We welcome contributions
            to fill these gaps!
          </p>
        </div>
      </ContentSection>
