    ...
    <>
      <div id={HASH} className="scroll-mt-[9rem]" ref={sectionRef}>
        ...
        <p>
          ...
          more details about the problem&apos;s features and why we consider it
          as representative for that modelling framework. Solvers that timed out
          or errored on a particular problem are indicated by red text above the
          corresponding bar.
        </p>
        <div className="my-4">
