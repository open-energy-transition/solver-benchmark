...
const HardwareConfigurations = () => {
  ...
  return (
    <div ref={sectionRef}>
      ...
      <p>
        We run benchmark problems on the following machine configurations and
        timeouts:
      </p>
      <ol className="list-decimal list-outside ml-6 text-base leading-relaxed">
        <li className="mb-2">
          Small and Medium sized benchmark problems are run with a timeout of 1
      ...
      <p>
        As a reminder, we classify problems into size categories based on the
