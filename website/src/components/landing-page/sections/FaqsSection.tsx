                ...
                <>
                  ...
                  <ul className="list-disc list-outside ml-6 mt-2">
                    <li className="mb-2">
                      ...
                      interest. For some problems, such as those sourced from
                      the MIPLIB benchmark library, the modelling framework is
                      unknown and shown as N/A — these problems are still
                      energy-related, just not generated by a named modelling
                      framework tool.
                    </li>
                    <li className="mb-2">
