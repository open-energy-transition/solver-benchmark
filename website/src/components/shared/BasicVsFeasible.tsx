  ...
  return (
    <div className="px-2 md:px-5 py-2 text-navy font-lato border border-[#CAD9EF] bg-[#F7F7F9] rounded-2xl">
      <div className="tag-line-xs leading-1.5">
        *<b>Caveat:</b> Our configuration of {getSolverLabel("highs-hipo")} and{" "}
        {getSolverLabel("highs-ipx")} return only feasible solutions, not
        necessarily basic, while {getSolverLabel("gurobi")} and{" "}
        {getSolverLabel("highs")} always return basic solutions by default. See
        our{" "}
