    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col h-full">
          <div className="overflow-auto overflow-x-hidden py-5 px-0 flex-1 text-white">
          ...
          <div
            className={`hidden shrink-0 justify-center pb-6 space-x-4 w-full lg:flex ${
              isNavExpanded ? "pl-2" : ""
            }`}
          >
            <button
