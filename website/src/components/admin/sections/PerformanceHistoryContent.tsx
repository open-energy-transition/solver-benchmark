      ...
      header={
        <div className="max-w-8xl mx-auto mt-8">
          ...
          <p className="mt-4 max-w-screen-lg">
            ...
            kinds of benchmarks. Once again, you can filter the benchmark set to
            your problems of interest and the graphs will automatically
...
export default PerformanceHistoryContent;
