...
const BenchmarkSetContent = () => {
  ...
  return (
    <div className="max-w-8xl mx-auto text-navy mt-8">
      <div>
        <div className="md:flex justify-between items-start gap-4">
          <div className="flex-1">
            <h5>Benchmark Set</h5>
            <p className="mb-6 mt-4 max-w-screen-lg">
              On this page you can see a list of all the benchmark problems on
              our platform. Click on a benchmark problem name to see all the
              details about the problem, including links to download the problem
              file, solution files, and logs.
            </p>
          </div>
          <Link
...
export default BenchmarkSetContent;
