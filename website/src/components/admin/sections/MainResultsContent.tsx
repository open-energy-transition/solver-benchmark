    ...
    <div className="max-w-8xl mx-auto text-navy">
      <div>
        ...
        <p className="mb-6 mt-4 max-w-screen-lg">
          We run our benchmarks on 2 different configurations: The <b>Short</b>{" "}
          tab below contains results of the smaller benchmarks (less than a
          million variables), run with a{" "}
          ...
          timeout on a more powerful machine. Select the desired tab to view a
          summary of the results on that configuration, along with the technical
      ...
      <div className="gap-6 flex flex-col bg-[#E6ECF5] border border-stroke border-t-0 pb-6 px-4 rounded-r-lg">
        ...
        <div className="sm:flex justify-between gap-5">
          ...
          <div id="benchmark-results" className="w-full h-max" ref={contentRef}>
            <div className="space-y-4 sm:space-y-6 min-h-96">
              ...
              <div className="px-2 md:px-5 py-2 text-navy font-lato border border-[#CAD9EF] bg-[#F7F7F9] rounded-2xl">
                <div className="tag-line-xs leading-1.5">
                  <b>Note:</b> As with all benchmarks, our results provide only
                  an indication of which solvers might be good for your
                  problems.
                  <br />
                  We recommend using{" "}
                  ...
                  to benchmark on your own problems before picking a solver. See
                  also the section on{" "}
                  <Link
                    href="#caveats"
                    className="hover:underline underline-offset-4 font-bold"
...
export default MainResultsContent;
